        ...
        $stateProvider
            .state('course', {
                ...
                data: {
                    ...
                    pageTitle: 'ziranliserverApp.course.home.title'
                },
                views: {
                    'content@': {
            ...
            .state('course-detail', {
                ...
                data: {
                    authorities: ['ROLE_USER'],
                    pageTitle: 'ziranliserverApp.course.detail.title'
                },
                views: {
                    'content@': {
            ...
            .state('course.pictures', {
                ...
                onEnter: ['$stateParams', '$state', '$uibModal', function ($stateParams, $state, $uibModal) {
                    $uibModal.open({
                        templateUrl: 'app/entities/course/course-pictures-dialog.html',
                        controller: 'CoursePicDialogController',
                        controllerAs: 'vm',
                        backdrop: 'static',
                        size: 'lg',
                        resolve: {
