...
import com.alienlab.ziranli.web.wechat.service.WechatMessageLogService;
...
public class WechatMessageLogResource {
    ...
    @Timed
    public ResponseEntity<WechatMessageLog> getWechatMessageLog(@PathVariable Long id) {
    ...
    @Timed
    public ResponseEntity<Void> deleteWechatMessageLog(@PathVariable Long id) {
