...
import com.alienlab.ziranli.web.wechat.bean.entity.WechatMaterial;
import com.alienlab.ziranli.web.wechat.service.WechatMaterialService;
...
public class WechatMaterialResource {
    ...
    @Timed
    public ResponseEntity<WechatMaterial> getWechatMaterial(@PathVariable Long id) {
    ...
    @Timed
    public ResponseEntity<Void> deleteWechatMaterial(@PathVariable Long id) {
