...
public class QrTypeResource {
    ...
    @Timed
    public ResponseEntity<QrType> getQrType(@PathVariable Long id) {
    ...
    @Timed
    public ResponseEntity<Void> deleteQrType(@PathVariable Long id) {
    ...
    @GetMapping(value="/qr-type-wechat")
    @Timed
